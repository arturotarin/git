...
public class ConnectFromSparkToCassandra_ReadTable implements Serializable {
    private transient SparkConf conf;

    private ConnectFromSparkToCassandra_ReadTable(SparkConf conf) {
        this.conf = conf;
    }
    ...
    public static void main(String[] args) {
        ...
        /*
		 * datastax@datastax:/home/datastax-$ ccm start
         */
        conf.set("spark.cassandra.connection.host", "datastax");

        ConnectFromSparkToCassandra_ReadTable app = new ConnectFromSparkToCassandra_ReadTable(conf);
        app.run();
    }
