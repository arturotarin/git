...
public class ConnectFromSparkToCassandra implements Serializable {
    private transient SparkConf conf;

    private ConnectFromSparkToCassandra(SparkConf conf) {
        this.conf = conf;
    }
    ...
    public static void main(String[] args) {
        ...
        ConnectFromSparkToCassandra app = new ConnectFromSparkToCassandra(conf);
        app.run();
    }
